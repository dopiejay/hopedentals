          ...
          {services.map((s) => {
            ...
            return (
              <Link
                key={s.title}
                to={`/services/${s.slug}`}
                className={`group relative block overflow-hidden rounded-3xl border border-stone/80 bg-gradient-to-br ${s.color} transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-shalom-gold/5`}
              >
                {/* Service image */}
